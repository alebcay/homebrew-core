class Libbluray < Formula
  ...
  url "https://get.videolan.org/libbluray/1.3.4/libbluray-1.3.4.tar.bz2"
  mirror "https://download.videolan.org/pub/videolan/libbluray/1.3.4/libbluray-1.3.4.tar.bz2"
